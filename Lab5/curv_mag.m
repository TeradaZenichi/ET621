...
plot(I1,V_1med_fase,'ms','Linewidth',2)

legend('Curva de magnetização','Curva do capacitor de 30\muF','Curva do capacitor de 25\muF','Curva do capacitor de 20\muF','Curva do capacitor de 15\muF', 'Pontos de medição')
